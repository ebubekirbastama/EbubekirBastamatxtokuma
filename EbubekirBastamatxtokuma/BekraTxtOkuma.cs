...
namespace EbubekirBastamatxtokuma
{
    public class BekraTxtOkuma
    {
        ...
        public void Txt_Aktar(string DosyaYolu, ListBox lst, bool encode)
        {
            txt_aktar(DosyaYolu, lst, encode);
        }
        public string[] Txt_Aktar_Dizi(string DosyaYolu, bool encode)
        {
            return txt_aktar_dizi(DosyaYolu, encode);
        }
    }
}
